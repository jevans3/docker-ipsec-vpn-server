...
LABEL maintainer="Lin Song <jesse.evans@infor.com>" \
    org.opencontainers.image.created="$BUILD_DATE" \
    org.opencontainers.image.version="$VERSION" \
    org.opencontainers.image.revision="$VCS_REF" \
    org.opencontainers.image.authors="Jesse Evans <jesse.evans@infor.com>" \
    ...
    org.opencontainers.image.url="https://github.com/jevans3/docker-ipsec-vpn-server" \
    org.opencontainers.image.source="https://github.com/jevans3/docker-ipsec-vpn-server" \
    org.opencontainers.image.documentation="https://github.com/jevans3/docker-ipsec-vpn-server"
